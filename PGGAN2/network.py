...
from custom_layers import EqualizedLinear, Conv_Block, ScaleBlock, PixelNormalizationLayer
from dataset import VariableImageFolder
from utility import MinibatchSTD, compute_gradient_penalty, exp_avg_update, calc_padding
...
class ProGAN(pl.LightningModule):
    ...
    def training_step(self, img_list, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:  # Discriminator Training:
            ...
            gradient_penalty = compute_gradient_penalty(discriminator= self.discriminator, real_samples=real_imgs, fake_samples=fake_imgs)
    ...
    def add_depth(self):
        ...
        # print('current image size: ' + self.img_size)
